...
Then('I should see {string} {string} {string} {string}') do |string, string2, string3, string4|
  if page.respond_to? :should
    page.should have_content(string)
    page.should have_content(string2)
    page.should have_content(string3)
    page.should have_content(string4)
...
When /^I fill in "(.*?)" date field with "(.*?)"$/ do |field_name, date_components|
  fill_in field_name, with: date_components
end
